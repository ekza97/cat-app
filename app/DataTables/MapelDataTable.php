...
class MapelDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function($row){
            ...
            $action .= '<form method="post" action="' . route("courses.destroy", Crypt::encrypt($row->id)) . '"
                id="deleteCourse" style="display:inline" data-bs-toggle="tooltip"
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('description')->title('Mata Pelajaran'),
